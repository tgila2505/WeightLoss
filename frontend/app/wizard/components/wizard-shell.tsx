...
export const WIZARD_STEPS: WizardStep[] = [
  ...
  { id: 'lifestyle', title: 'Lifestyle', subtitle: 'Activity, sleep and daily habits', nodeIds: [], optional: false },
  { id: 'diet', title: 'Diet & Nutrition', subtitle: 'Food preferences and restrictions', nodeIds: [], optional: false },
  {
    id: 'family-history',
